...
SELECT TSUB.CSUBSISTEMA || '-' || TSUB.CTRANSACCION AS TRANSACCION, TSUB.DESCRIPCION FROM TSUBSISTEMATRANSACCIONES TSUB
        WHERE DESCRIPCION LIKE UPPER('%emergencia%') AND 
FHASTA > SYSDATE --and TSUB.CSUBSISTEMA = '03'
;
