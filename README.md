...
Usa el código con precaución.Data Manipulation Language (DML)DML is utilized to modify, add, or erase data within existing tables.Insert a Single Row: Adds a new record containing explicitly defined values into a table.
<div align="center">
        <!-- TYPING ANIMATION -->
